...
The package also provides functions to compute density and probability functions and
...
You can install the development version of TempStable from [GitHub](https://github.com/) with:
